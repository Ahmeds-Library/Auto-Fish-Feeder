...
export function DevicesPage() {
  ...
  return (
    <>
      ...
      <div className="mb-6 flex flex-col gap-3 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.055] p-5 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.28em] text-cyan-300">Fleet inventory</p>
          <h2 className="mt-2 text-2xl font-black text-white">Device health and inventory</h2>
